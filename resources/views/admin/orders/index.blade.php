                            ...
                            <tr class="hover:bg-ant-bg/30 transition-all duration-200 group">
                                ...
                                <td class="py-4 px-6 text-center">
                                    <a href="{{ route('admin.orders.show', $o->id_reservasi) }}" 
                                       class="inline-flex items-center gap-2 px-4 py-1.5 bg-white border border-ant-borderSplit text-ant-text text-[13px] font-bold rounded-lg transition-all hover:bg-ant-primary hover:text-white hover:border-ant-primary hover:shadow-md group/btn">
